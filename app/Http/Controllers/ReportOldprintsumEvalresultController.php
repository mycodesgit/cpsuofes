...
class ReportOldprintsumEvalresultController extends Controller
{
    public function  summaryEvalStore()
    {
        ...
        return view('reports.prntsummaryevalresult.oldevaluationsummaryprint', compact('currsem', 'collegelist'));
    }
    ...
    public function summaryEvalFilter(Request $request)
    {
        ...
        return view('reports.prntsummaryevalresult.oldevaluationsummaryprintsearchresult', compact('currsem', 'facdetail', 'rating_period'));
    }
    ...
    public function gensummaryevalPDF(Request $request)
    {
        ...
        $pdf = PDF::loadView('reports.prntsummaryevalresult.formpdf.pdfsummaryeval', $data)->setPaper('Legal', 'portrait');
        return $pdf->stream();
    }
    ...
    public function gencommentsevalPDF(Request $request)
    {
        ...
        $pdf = PDF::loadView('reports.prntsummaryevalresult.formpdf.pdfComments', $data)->setPaper('Legal', 'portrait');
        return $pdf->stream();
    }
    ...
    public function genpointsevalPDF(Request $request)
    {
        ...
        $pdf = PDF::loadView('reports.prntsummaryevalresult.formpdf.pdfPoints', $data)->setPaper('Legal', 'landscape');
        return $pdf->stream();
    }
    ...
    public function gensumsheetevalPDF(Request $request)
    {
        ...
        $pdf = PDF::loadView('reports.prntsummaryevalresult.formpdf.pdfSumSheet', $data)->setPaper('Legal', 'portrait');
        return $pdf->stream();
    }
