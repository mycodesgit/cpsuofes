    ...
    <div class="container d-flex align-items-center justify-content-center min-vh-100">
        <div class="" style="max-width: 500px; width: 100%;">
            <div class="text-center">
                ...
                <h2 class="card-title h4 mb-3">Server Error</h2>
                <p class="text-muted mb-5">We're experiencing technical difficulties. Please refresh the page or try again in a few minutes or contact support if the problem persists.</p>
